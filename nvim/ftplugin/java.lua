...
local function jdtls_on_attach(_, bufnr)
	...
	nmap('<leader>o', "<Cmd>lua require('jdtls').organize_imports()<CR>", "[O]rganize Imports")
	nmap('<leader>df', "<Cmd>lua require('jdtls').test_class()<CR>", "[D]ebug [F]ile")
	nmap('<leader>dm', "<Cmd>lua require('jdtls').test_nearest_method()<CR>", "[D]ebug [M]ethod")
end
